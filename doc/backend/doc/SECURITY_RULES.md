...
This is the backend documentation copy of the mandatory cross-stack policy in [`../../SECURITY_RULES.md`](../../SECURITY_RULES.md). When rules conflict, the shared policy wins.
